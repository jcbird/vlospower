...
subs = originalsim.__deepcopy__()[(originalsim['tform']>9.3) & (originalsim['tform']<12.32) & (originalsim['r']<30.0)]
...
vcxyRfit = interpolate.InterpolatedUnivariateSpline(rbins, medvcxy)
vrxyRfit = interpolate.InterpolatedUnivariateSpline(rbins, medvrxy)
...
minmax_cm = 20 #N used for vmax, vmin
cmapp = 'Spectral'
